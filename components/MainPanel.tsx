...
const MainPanel: React.FC<MainPanelProps> = ({ flowerItems, setFlowerItems, fixedItems, onNavigateToSettings }) => {
      ...
      <div className="md:w-1/3">
        <div className="sticky top-8 bg-gray-800/50 rounded-2xl p-6 border border-gray-700 flex flex-col h-full">
          <div className="flex justify-between items-center">
             ...
             <button onClick={onNavigateToSettings} className="p-2 bg-gray-700 rounded-full hover:bg-gray-600 transition-colors" title="Ir a Ajustes">
