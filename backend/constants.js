...
const DEFAULT_FLOWER_ITEMS = [
    ...
    {
      "id": "f12", "name": "Gypsophila (L)", "price": 30, "visible": true,
      "imageUrl": "https://storage.googleapis.com/gemini-prod-us-west1-assets/images/5752c0f9-2e06-4448-a0c3-f66741757833.jpeg",
...
const DEFAULT_VARIATION_GIFTS = [
    {
      "id": "v1", "name": "Box Cuadrado", "price": 20, "visible": true,
      "imageUrl": "https://magia.pe/cdn/shop/files/magia-diadelamadre-2.png?v=1713231274",
      "costo": 10
    },
    {
      "id": "v2", "name": "Ramo Coreano", "price": 15, "visible": true,
    ...
    {
      "id": "v3", "name": "Ramo Clásico", "price": 5, "visible": true,
